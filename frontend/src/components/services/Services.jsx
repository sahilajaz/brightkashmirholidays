  ...
  const travelPackages = [
    {
      id: 1,
      name: 'Pahalgam',
      description: 'Chill in the mountains with lush waters with our exclusive package.',
      price: '5000',
    },
    {
      id: 2,
      name: 'Gulmarg',
      description: 'Relax in the snow-laden meadows of North Kashmir.',
      price: '3000',
    },
    {
      id: 3,
      name: 'Aharbal',
      description: 'Kashmiri Niagara Falls.',
      price: '1000',
    },
  ];
      ...
      <div className="packages">
        {travelPackages.map((pkg) => (
          <div key={pkg.id} className="package-card">
            <h2>{pkg.name}</h2>
            <p>{pkg.description}</p>
            <p className="price">Price: {pkg.price} INR</p>
            <button onClick={() => openForm(pkg)} disabled={loading[pkg.id]}>
